...
#ifndef SymbolFileDWARF_DWARFASTParserMotoko_h_
#define SymbolFileDWARF_DWARFASTParserMotoko_h_
...
class DWARFASTParserMotoko : public DWARFASTParser {
public:
  DWARFASTParserMotoko(lldb_private::MotokoASTContext &ast)
    : m_ast(ast)
  {
  }
...
private:
  ...
  lldb_private::MotokoASTContext &m_ast;

  // The Motoko compiler will emit a DW_TAG_enumeration_type for the
...
#endif // SymbolFileDWARF_DWARFASTParserMotoko_h_
